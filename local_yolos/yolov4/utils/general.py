...
from attack.PhantomSponges.local_yolos.yolov4.utils.google_utils import gsutil_getsize
from attack.PhantomSponges.local_yolos.yolov4.utils.metrics import fitness, fitness_p, fitness_r, fitness_ap50, fitness_ap, fitness_f
from attack.PhantomSponges.local_yolos.yolov4.utils.torch_utils import init_torch_seeds
...
def strip_optimizer(f='weights/best.pt', s=''):  # from attack.PhantomSponges.local_yolos.yolov4.utils.general import *; strip_optimizer()

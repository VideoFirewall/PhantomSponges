...
def strip_optimizer(f='weights/last.pt'):  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; strip_optimizer()
...
def create_backbone(f='weights/last.pt'):  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; create_backbone()
...
def coco_only_people(path='../coco/labels/train2017/'):  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; coco_only_people()
...
def select_best_evolve(path='evolve*.txt'):  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; select_best_evolve()
...
def crop_images_random(path='../images/', scale=0.50):  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; crop_images_random()
...
def coco_single_class_labels(path='../coco/labels/train2014/', label_class=43):
    # Makes single-class coco datasets. from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; coco_single_class_labels()
...
def kmean_anchors(path='../coco/train2017.txt', n=12, img_size=(320, 1024), thr=0.10, gen=1000):
    # Creates kmeans anchors for use in *.cfg files: from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; _ = kmean_anchors()
    # n: number of anchors
    # img_size: (min, max) image size used for multi-scale training (can be same values)
    # thr: IoU threshold hyperparameter used for training (0.0 - 1.0)
    # gen: generations to evolve anchors using genetic algorithm
    from attack.PhantomSponges.local_yolos.yolov4.utils.datasets import LoadImagesAndLabels
...
def plot_wh_methods():  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; plot_wh_methods()
...
def plot_test_txt():  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; plot_test()
...
def plot_targets_txt():  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; plot_targets_txt()
...
def plot_evolution_results(hyp):  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; plot_evolution_results(hyp)
...
def plot_results_overlay(start=0, stop=0):  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; plot_results_overlay()
...
def plot_results(start=0, stop=0, bucket='', id=()):  # from attack.PhantomSponges.local_yolos.yolov4.utils.utils import *; plot_results()

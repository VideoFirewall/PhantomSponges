...
def attempt_download(weights):
    ...
    models = ['yolov4-csp.pt', 'yolov4-csp-x.pt']  # available local_yolos
...
def gdrive_download(id='1n_oKgR81BJtqk75b00eAjdv03qVCQn2f', name='coco128.zip'):
    # Downloads a file from Google Drive. from attack.PhantomSponges.local_yolos.yolov4.utils.google_utils import *; gdrive_download()
    t = time.time()

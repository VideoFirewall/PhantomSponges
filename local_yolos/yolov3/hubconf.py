...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from attack.PhantomSponges.local_yolos.yolov3.models.experimental import attempt_load
    from attack.PhantomSponges.local_yolos.yolov3.models.yolo import Model
    from attack.PhantomSponges.local_yolos.yolov3.utils.downloads import attempt_download
    from attack.PhantomSponges.local_yolos.yolov3.utils.general import check_requirements, intersect_dicts, set_logging
    from attack.PhantomSponges.local_yolos.yolov3.utils.torch_utils import select_device

...
from attack.PhantomSponges.local_yolos.yolov3.utils.general import LOGGER, colorstr, emojis
...
def kmean_anchors(dataset='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    """ Creates kmeans-evolved anchors from training dataset
        ...
        Usage:
            from attack.PhantomSponges.local_yolos.yolov3.utils.autoanchor import *; _ = kmean_anchors()
    """
    ...
    if isinstance(dataset, str):  # *.yaml file
        ...
        from attack.PhantomSponges.local_yolos.yolov3.utils.datasets import LoadImagesAndLabels

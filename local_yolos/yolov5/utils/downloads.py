...
def safe_download(file, url, url2=None, min_bytes=1E0, error_msg=''):
    ...
    from attack.PhantomSponges.local_yolos.yolov5.utils.general import LOGGER
...
def gdrive_download(id='16TiPfZj7htmTyhntwcZyEEAejOUxuT6m', file='tmp.zip'):
    # Downloads a file from Google Drive. from yolov5_local.utils.downloads import *; gdrive_download()
    t = time.time()
    file = Path(file)

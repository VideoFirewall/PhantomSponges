...
from PhantomSponges.local_yolos.yolov5.models.yolo import Detect
...
def export_saved_model(model,
    ...
    try:
        ...
        from PhantomSponges.local_yolos.tf import TFDetect, TFModel
...
def export_tflite(keras_model, im, file, int8, data, nms, agnostic_nms, prefix=colorstr('TensorFlow Lite:')):
    ...
    try:
        ...
        if int8:
            from PhantomSponges.local_yolos.tf import representative_dataset_gen
